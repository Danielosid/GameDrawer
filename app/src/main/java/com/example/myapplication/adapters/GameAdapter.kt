...
class GameAdapter(val gameModel: MutableList<GameModel>): RecyclerView.Adapter<GameViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GameViewHolder {
        ...
        return GameViewHolder(view,mListener)
    }
...
class GameViewHolder(itemView: View,listener: GameAdapter.onItemClickListener): RecyclerView.ViewHolder(itemView){
